...
{
    public class TypesWhiteSpaceCleanerDeobfuscator : DeobfuscatorBase
    {
        public TypesWhiteSpaceCleanerDeobfuscator(ModuleDefModel moduleDefModel) : base(moduleDefModel)
        {
        }
